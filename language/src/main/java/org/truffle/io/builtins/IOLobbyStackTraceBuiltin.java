...
public abstract class IOLobbyStackTraceBuiltin extends IOBuiltinNode {
    ...
    private static TruffleString createStackTrace() {
        ...
        Truffle.getRuntime().iterateFrames(new FrameInstanceVisitor<Integer>() {
            ...
            public Integer visitFrame(FrameInstance frameInstance) {
                ...
                if (str.byteLength() > 0) {
                    str.appendStringUncached(IOSymbols.fromJavaString(System.getProperty("line.separator")));
                }
                ...
                for (int i = 0; i < count; i++) {
                    ...
                    str.appendStringUncached(IOSymbols.fromObject(frame.getValue(i)));
                }
                return null;
            }
        });
    ...
    private static TruffleString getRootNodeName(RootNode rootNode) {
        if (rootNode instanceof IOFunctionRootNode) {
            ...
            return IOSymbols.fromJavaString(rootNode.getName());
        }
    }
}
