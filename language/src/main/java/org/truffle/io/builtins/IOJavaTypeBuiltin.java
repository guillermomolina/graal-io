...
public abstract class IOJavaTypeBuiltin extends IOBuiltinNode {
    ...
    public Object doLookup(Object symbolName,
        ...
        try {
             ...
             * are expressible also in IO. Like function calls on objects.
             */
            return IOState.get(this).getEnv().lookupHostSymbol(interop.asString(symbolName));
        } catch (UnsupportedMessageException e) {
            throw new IOLanguageException("The java builtin expected a String argument, but a non-string argument was provided.", this);
        }
    }
