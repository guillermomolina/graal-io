...
public class IOPrototypes {
    public static final IOObject OBJECT = constant(null);
    public static final IOObject METHOD = new IOObject(OBJECT);
    public static final IOObject STRING = new IOObject(OBJECT);
    ...
    public static IOObject constant(IOObject prototype) {
