...
public final class IOState {
    ...
    public void installBuiltin(NodeFactory<? extends IOBuiltinNode> factory, final IOObject target, final String targetName) {
        /*
    ...
    public IOMethod createMethod(RootCallTarget callTarget, final TruffleString[] parameters, final MaterializedFrame frame) {
        allocationReporter.onEnter(null, 0, AllocationReporter.SIZE_UNKNOWN);
