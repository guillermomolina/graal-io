...
public final class IOBigNumber extends IOObject implements Comparable<IOBigNumber> {
    ...
    @TruffleBoundary
    public int compareTo(IOBigNumber o) {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof IOBigNumber) {
            return value.equals(((IOBigNumber) obj).getValue());
        }
        return false;
    }
