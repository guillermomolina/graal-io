...
/**
 * The loop body of a {@link IOWhileNode while loop}. A Truffle framework {@link LoopNode} between
 * the {@link IOWhileNode} and {@link IOWhileRepeatingNode} allows Truffle to perform loop
 * optimizations, for example, compile just the loop body for long running loops.
 */
public final class IOWhileRepeatingNode extends Node implements RepeatingNode {

    /**
     * The condition of the loop. This in a {@link IOExpressionNode} because we require a result
    ...
    /** Expression (or {@link IOBlockNode block}) executed as long as the condition is true. */
    ...
    public IOWhileRepeatingNode(IOExpressionNode conditionNode, IOExpressionNode bodyNode) {
