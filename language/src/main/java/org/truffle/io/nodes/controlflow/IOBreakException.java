...
/**
 * Exception thrown by the {@link IOBreakNode break expression} and caught by the {@link IOWhileNode
 ...
 */
public final class IOBreakException extends ControlFlowException {

    public static final IOBreakException SINGLETON = new IOBreakException();

    private static final long serialVersionUID = -91013036379258890L;

    /* Prevent instantiation from outside. */
    private IOBreakException() {
    }
}
