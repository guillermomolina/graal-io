 ...
 * expressed in using this base class for {@link IOLogicalAndNode} and {@link IOLogicalOrNode}.
 */
public abstract class IOShortCircuitNode extends IOExpressionNode {

    @Child private IOExpressionNode left;
    @Child private IOExpressionNode right;
    ...
    public IOShortCircuitNode(IOExpressionNode left, IOExpressionNode right) {
        this.left = left;
        this.right = right;
    }
