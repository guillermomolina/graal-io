...
public final class InvokeInvokableNode extends IONode {
    ...
    public InvokeInvokableNode(final IOInvokable invokable, final Object target, final MessageLiteralNode messageNode) {
    ...
    protected final Object executeMethod(IOMethod method, VirtualFrame frame) {
        assert target instanceof IOObject;
        IOLocals sender = IOState.get(this).createLocals((IOObject)target, frame.materialize());
