...
public class IOFunctionRootNode extends IORootNode {

    /** The name of the function, for printing purposes only. */
    private final TruffleString name;


    public IOFunctionRootNode(IOLanguage language, FrameDescriptor frameDescriptor, IOExpressionNode bodyNode, SourceSection sourceSection, TruffleString name) {
