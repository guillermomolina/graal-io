...
public final class IOIfNode extends IOExpressionNode {

    /**
     * The condition of the {@code if}. This in a {@link IOExpressionNode} because we require a
     ...
     */
    @Child private IOExpressionNode conditionNode;

    /** Expression (or {@link IOBlockNode block}) executed when the condition is true. */
    @Child private IOExpressionNode thenPartNode;

    /** Expression (or {@link IOBlockNode block}) executed when the condition is false. */
    @Child private IOExpressionNode elsePartNode;
    ...
    public IOIfNode(IOExpressionNode conditionNode, IOExpressionNode thenPartNode, IOExpressionNode elsePartNode) {
        this.conditionNode = IOUnboxNodeGen.create(conditionNode);
    ...
    public Object executeGeneric(VirtualFrame frame) {
        ...
        if (condition.profile(evaluateCondition(frame))) {
            ...
            /* Execute the else-branch (which is optional according to the IO syntax). */
    ...
    private boolean evaluateCondition(VirtualFrame frame) {
        try {
            ...
            /*
             * The condition evaluated to a non-boolean result. This is a type error in the IO
             * program.
             */
