...
public final class ReadMemberNode extends IoNode {
    ...
    public ReadMemberNode(final IoNode receiverNode, final IoNode nameNode) {
    ...
    public Object executeGeneric(VirtualFrame frame) {
        ...
        Object value = IoObjectUtil.getOrDefault(receiver, name);
        if (value == null) {
