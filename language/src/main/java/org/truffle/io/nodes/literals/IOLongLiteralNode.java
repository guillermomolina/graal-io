 ...
 * parent expects a long value and calls {@link IOLongLiteralNode#executeLong}. In the generic case,
 * the primitive value is automatically boxed by Java.
 */
@NodeInfo(shortName = "const")
public final class IOLongLiteralNode extends IOExpressionNode {

    private final long value;

    public IOLongLiteralNode(long value) {
        this.value = value;
    }
