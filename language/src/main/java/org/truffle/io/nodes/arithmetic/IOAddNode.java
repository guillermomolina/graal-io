...
@NodeInfo(shortName = "+")
public abstract class IOAddNode extends IOBinaryNode {
    ...
    protected TruffleString add(Object left, Object right,
                    @Cached IOToTruffleStringNode toTruffleStringNodeLeft,
                    @Cached IOToTruffleStringNode toTruffleStringNodeRight,
