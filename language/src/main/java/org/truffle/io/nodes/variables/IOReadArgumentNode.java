...
import org.truffle.io.parser.IONodeFactory;
 ...
 * variables {@link IONodeFactory#addFormalParameter in the method prologue}.
 */
public class IOReadArgumentNode extends IOExpressionNode {
    ...
    public IOReadArgumentNode(int index) {
        this.index = index;
    }
