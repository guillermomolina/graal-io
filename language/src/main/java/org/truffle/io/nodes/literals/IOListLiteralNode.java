...
public final class IOListLiteralNode extends IOExpressionNode {

    @Children
    private final IOExpressionNode[] elementNodes;

    public IOListLiteralNode(IOExpressionNode[] elementNodes) {
    ...
    public Object executeGeneric(VirtualFrame frame) {
        ...
        Object[] argumentValues = new Object[elementNodes.length];
