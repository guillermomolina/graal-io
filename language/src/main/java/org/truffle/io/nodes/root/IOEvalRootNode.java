 ...
 * </ul>
 */
public final class IOEvalRootNode extends RootNode {

    private static final TruffleString ROOT_EVAL = IOSymbols.constant("root eval");

    @Child private DirectCallNode mainCallNode;

    public IOEvalRootNode(IOLanguage language, RootCallTarget rootFunction) {
        super(language);
