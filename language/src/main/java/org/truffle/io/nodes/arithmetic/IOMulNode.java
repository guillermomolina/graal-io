 ...
 */
@NodeInfo(shortName = "*")
public abstract class IOMulNode extends IOBinaryNode {
    ...
    @Specialization
    @TruffleBoundary
    protected IOBigNumber mul(IOBigNumber left, IOBigNumber right) {
        return new IOBigNumber(left.getValue().multiply(right.getValue()));
    }
