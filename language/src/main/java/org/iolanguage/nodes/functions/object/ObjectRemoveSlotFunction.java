...
@NodeInfo(shortName = "removeSlot")
public abstract class ObjectRemoveSlotFunction extends FunctionBodyNode {
    static final int LIBRARY_LIMIT = 3;

    @Specialization(guards = "objects.hasMembers(receiver)", limit = "LIBRARY_LIMIT")
    public Object removeIOObject(Object receiver, Object name,
