...
@NodeInfo(shortName = "encoding")
public abstract class SequenceEncodingFunction extends FunctionBodyNode {

    @Specialization(guards = "isString(receiver)")
    @TruffleBoundary
    protected Object encodingString(Object receiver,
            @Cached ToTruffleStringNode toTruffleStringNode) {
        throw new NotImplementedException();
    }

    @Specialization
    protected Object encodingSequence(IoSequence receiver) {
        return receiver.getEncoding();
    }
