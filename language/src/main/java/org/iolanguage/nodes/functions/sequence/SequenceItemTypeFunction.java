...
@NodeInfo(shortName = "itemType")
public abstract class SequenceItemTypeFunction extends FunctionBodyNode {

    @Specialization
    protected Object getItemType(IoSequence receiver) {
        throw new NotImplementedException();
        //return receiver.getItemType();
    }
}
