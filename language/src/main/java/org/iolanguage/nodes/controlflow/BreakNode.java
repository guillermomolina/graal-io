 ...
 * frames that are between this {@link BreakNode} and the {@link WhileNode} of the loop we are
 * breaking out. This is done by throwing an {@link BreakException exception} that is caught by
